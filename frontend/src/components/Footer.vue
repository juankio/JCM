        ...
        <div
            ...
            <div class="flex-shrink-0 w-64 mx-auto text-center md:mx-0 md:text-left">
                <a class="flex items-center justify-center font-medium text-white title-font md:justify-start">
                    <h2 class="mb-3 text-sm font-medium tracking-widest text-white uppercase title-font">JCM Fotos y Videos</h2>
                </a>
                <p class="mt-2 text-sm text-gray-500">Redes sociales</p>
                <div class="mt-4">
            ...
            <div class="flex flex-wrap flex-grow mt-10 -mb-10 text-center md:pl-20 md:mt-0 md:text-left">
                <div class="w-full px-4 lg:w-1/4 md:w-1/2">
                    <h2 class="mb-3 text-sm font-medium tracking-widest text-white uppercase title-font">Acerca de</h2>
                ...
                <div class="w-full px-4 lg:w-1/4 md:w-1/2">
                    ...
                    <nav class="mb-10 list-none">
                        <li class="mt-3">
                            <a class="text-gray-500 cursor-pointer hover:text-gray-900">Soporte de contacto</a>
                        </li>
                    </nav>
                </div>
                <div class="w-full px-4 lg:w-1/4 md:w-1/2">
